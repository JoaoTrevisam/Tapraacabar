                ...
                <tr>
                    ...
                    <td class="conteudo-esconder-pdf">
                        ...
                        <button 
                            ...
                            onclick="gerarPDFDieta(<?php echo $dieta->id; ?>)">
                            PDF <i class=""></i>
                        </button>
                        <button 
...
$(document).ready(function() {
    ...
    window.gerarPDFDieta = function(dietaId) {
        // Implementar a lógica para gerar o PDF da dieta
        console.log("Gerar PDF da dieta com ID:", dietaId);
        // Aqui você pode usar uma biblioteca como jsPDF para gerar o PDF
    };

    // Função para gerar PDF geral
    window.gerarPDF = function() {
        // Implementar a lógica para gerar o PDF geral
        console.log("Gerar PDF geral");
        // Aqui você pode usar uma biblioteca como jsPDF para gerar o PDF
    };
});
</script>
